  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: <Widget>[
          SizedBox.expand(
            child: Image.asset("assets/sk5.jpg", fit: BoxFit.cover,),
          ),
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  Text("Shamaun Kabir", style: TextStyle(color: Colors.grey[800], fontFamily: "Roboto",
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            SizedBox(height: 8,),
                            Text("Hello, this is Kabir, and I am from easy approach, and this is just a demo text for information about me"
                                "Hello, this is Kabir, and I am from easy approach, and this is just a demo text for information about me",
